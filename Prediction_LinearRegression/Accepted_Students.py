#Continue your exploration of linear regression using a public dataset provided courtesy of An Introduction to
# Statistical Learning, called College Acceptance and Enrollment. There are four relationships we are interested in
# modeling:
...
# The amount charged for room and board coupled with the number of enrolled students, expressed as a function of: the
# number of accepted students.
# You should be able to find these relationships given the dataset.
...
X_train, X_test, y_train, y_test=train_test_split(roomboard, accepted, test_size=0.3, random_state=7)
...
drawLine(model2, X_test, y_test, "Accept(Enroll)", score)
...
failunder=X[['F.Undergrad']]
X_train, X_test, y_train, y_test=train_test_split(failunder, accepted, test_size=0.3, random_state=7)
model3=model.fit(X_train, y_train)
score=model3.score(X_test, y_test)
drawLine(model3, X_test, y_test, "Accept(F.Undergrad)", score)
...
roomenrolled=X[['Room.Board','Enroll']]
X_train, X_test, y_train, y_test=train_test_split(roomenrolled, accepted, test_size=0.3, random_state=7)
model4=model.fit(X_train, y_train)
score=model4.score(X_test, y_test)
drawPlane(model4, X_test, y_test, "Accept(Room&Board,Enroll)", score)
plt.savefig('Accepted_Students.png', bbox_inches='tight', dpi=300)
