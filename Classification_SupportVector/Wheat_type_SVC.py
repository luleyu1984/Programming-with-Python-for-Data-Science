#In this lab, you'll get started with support vector classifier by revisiting UCI's wheat-seeds dataset.
# First, you will benchmark how long it takes to train and predict with SVC relative to how long K-Neighbors took
# to train and test, and then you'll compare the decision boundary plot produced by the two.
...
plt.savefig('Wheat_type_KNeighbors.png', dpi=300)

benchmark(svc, X_train, X_test, y_train, y_test, 'SVC')
drawPlots(svc, X_train, X_test, y_train, y_test, 'SVC')
plt.savefig('Wheat_type_SVC.png', dpi=300)

plt.show()


#KNeighbors Results
#5000 Iterations Training Time:  2.2400779724121094
#5000 Iterations Scoring Time:  4.8264970779418945
#High-Dimensionality Score:  83.607
#Max 2D Score:  90.164


#SVC Results
#5000 Iterations Training Time:  4.549623012542725
#5000 Iterations Scoring Time:  2.00018310546875
